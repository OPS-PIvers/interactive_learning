...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-8 max-w-md w-full mx-4 text-slate-100">
          ...
          <form onSubmit={handlePasswordReset} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 text-slate-100"
                required
              />
            </div>
            <button
