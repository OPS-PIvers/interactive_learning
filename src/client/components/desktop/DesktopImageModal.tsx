...
const DesktopImageModal: React.FC<DesktopImageModalProps> = ({ 
  event, 
  onComplete,
  ...
  const title = event.title || 'Image';
  const imageUrl = event.mediaUrl || event.text; // text field may contain image URL
