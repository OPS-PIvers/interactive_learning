...
const MediaModal: React.FC<MediaModalProps> = ({ 
  ...
  const sizeClasses = {
    small: 'max-w-md max-h-[70vh]',
    medium: 'max-w-2xl max-h-[80vh]',
  ...
  return (
    ...
    >
      <div className={`bg-slate-900 rounded-xl shadow-2xl w-full ${sizeClasses[size]} flex flex-col overflow-hidden border border-slate-700 animate-in zoom-in-95 duration-200`}>
