...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-sm flex items-center justify-center z-50 p-2 transition-opacity duration-300 ease-in-out"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        ref={modalRef}
        tabIndex={-1}
        className="bg-slate-800 rounded-xl shadow-2xl w-full max-w-[95vw] h-[95vh] flex flex-col overflow-hidden border border-slate-700"
      >
