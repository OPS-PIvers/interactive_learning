...
const HotspotEditorModal: React.FC<HotspotEditorModalProps> = ({
  ...
  const [effectParameters, setEffectParameters] = useState<Record<string, unknown>>(() => {
    if (existingInteraction?.effect) {
      return existingInteraction.effect.parameters as unknown as Record<string, unknown>;
    }
  ...
  useEffect(() => {
    if (existingInteraction?.effect) {
      ...
      setEffectParameters(existingInteraction.effect.parameters as unknown as Record<string, unknown>);
    }
  }, [existingInteraction]);
    ...
    const updatedHotspot: SlideElement = {
      ...
      interactions: [{
        ...
        effect: {
          ...
          duration: 3000,
          parameters: finalParameters as unknown as EffectParameters
        }
      }]
    };
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 h-20 text-white placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
            ...
            {effectParameters['videoSource'] === 'youtube' ? (
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              {/* Force placeholder color to be visible on any background */}
              className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
