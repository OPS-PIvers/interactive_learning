...
const timelineEvents: TimelineEventData[] = [
  ...
  // Step 2: Show Media (images handled as media)
  { id: 'te2', step: 2, name: 'Show Media for hs2', type: InteractionType.VIDEO, targetId: 'hs2', videoUrl: '/assets/demo-background.jpg', caption: 'This is a demo image.', videoDisplayMode: 'inline' },
  // Step 3: Quiz
  ...
  // Step 4: Play Video
  { id: 'te4', step: 4, name: 'Play Video for hs4', type: InteractionType.VIDEO, targetId: 'hs4', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', autoplay: true, loop: true, videoSource: 'url', videoDisplayMode: 'inline', videoShowControls: true },
  // Step 5: Play Audio
  { id: 'te5', step: 5, name: 'Play Audio for hs5', type: InteractionType.AUDIO, targetId: 'hs5', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', volume: 80, audioDisplayMode: 'mini-player', audioShowControls: true },
  // Step 6: Show Text
  { id: 'te6', step: 6, name: 'Show Text for hs6', type: InteractionType.TEXT, targetId: 'hs6', textContent: 'This is a demonstration text message!', textPosition: 'center' },
